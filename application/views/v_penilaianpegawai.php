                                        ...
                                        <tbody>
                                         ...
                                         foreach($data->result_array() as $i):
                                          ...
                                          <tr>
                                            ...
                                            <td>            <button type="button" class="btn bg-green waves-effect" onclick="viewKriteria(<?php echo $id_periode; ?>,<?php echo $id; ?>)">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            ...
                                                            <select class="form-control" name="status<?php echo $id;?>" id="edit_status<?php echo $id;?>">
                                                                ...
                                                                <option value="Kepala Cabang" <?php if ($status=='Kepala Cabang') {echo "selected";}?>>Kepala Cabang</option>
                                                                <option value="Kepala Departemen" <?php if ($status=='Kepala Departemen') {echo "selected";}?>>Kepala Departemen</option>
...
function viewKriteria(id,id_dinilai){
        window.location ="<?php echo site_url('pegawaicontroller/v_formpenilaian/'); ?>"+id+"/"+id_dinilai;
    }
